...
void farming()
{
    ...
    const float REAR_WALL_TARGET = 157; // mm target for US sensor when driving backwards (course is 1991mm long)
    ...
    // delay(100);
    const float SIDE_WALL_THRESHOLD = 105; // mm distance to far wall to consider course complete
